...
public class WorkA {
    ...
    // Build a random string of characters of length count
  public static String randomAlphaNumeric(int count) {

    // For int i = 0 to count - 1, append random character from ALPHA_NUMERIC_STRING
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Get our block data from user input instead of from file
    Scanner ourInput = new Scanner(System.in);
    System.out.print("Enter some blockdata: ");
    String stringIn = ourInput.nextLine();

    randString = randomAlphaNumeric(8);  // Randomly generated from our function above
    ...
    try {
      ...
      for(int i=1; i<20; i++){ // Limit how long we try for this example.
            ...
            byte[] bytesHash = MD.digest(concatString.getBytes("UTF-8")); // Get the hash value of the input string + random seed string
