...
public class BlockH {
  ...
  public static void main(String[] args) throws Exception {
	 ...
	 */
      ...
      /* CDE: In case you want to use it for something, here we encrypt a string, then decrypt it, using the same public key technology. These
	 techniques are not needed for the basic CSC435 assignment. Note that this method is intended for 117 bytes or less to pass session keys: */
